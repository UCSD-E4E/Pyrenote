...
describe('Drawer', () => {
  ...
  /** @test {wrapper} */
  it('wrapper should exist and have correct tagName', () => {
    expect(drawer.wrapper).toBeTruthy();
    expect(drawer.wrapper.tagName.toLowerCase()).toBe('wave');
  });

  /** @test {handleEvent/0.5} */
  it('handleEvent should return 0.5 if clicked in the middle of wrapper', () => {
  ...
  it('handleEvent should return 0.9 if clicked 10% from the end', () => {
    const { right, width } = drawer.wrapper.getBoundingClientRect();
  ...
  it('handleEvent should return 0 if clicked on wrapper left position', () => {
  ...
  it('handleEvent should return 0 if clicked on wrapper left position -1px', () => {
    const { left } = drawer.wrapper.getBoundingClientRect();
  ...
  /** @test {handleEvent/left+1} */
  it('handleEvent should not return 0 if clicked on wrapper left position +1px', () => {
    const { left } = drawer.wrapper.getBoundingClientRect();
  ...
  it('handleEvent should return 1 if clicked on wrapper right position', () => {
  ...
  it('handleEvent should return 1 if clicked on wrapper right position +1px', () => {
    const { right } = drawer.wrapper.getBoundingClientRect();
  ...
  /** @test {handleEvent/right-1} */
  it('handleEvent should not return 1 if clicked on wrapper right position -1px', () => {
    const { right } = drawer.wrapper.getBoundingClientRect();
